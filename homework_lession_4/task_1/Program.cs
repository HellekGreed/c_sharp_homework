double GetExp(double number1, double number2)
{
       ...
       //  double result = Math.Pow(number1, number2);
        ...
        if(number2 < 0) // Если степень отрицательная ответом будет еденица деленная на результат возведения в степень 
        {
                return 1 / result;
        }
       
        return result; // Любое число возведенное в нулевую степень дает еденицу (метод Math.Pow(0, 0) выдает еденицу)
