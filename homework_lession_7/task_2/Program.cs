...
Console.WriteLine();
// Я думал как сделать нумерацию позиции, с 0 строки и столбца или с первых. Оставил с первых так как глупо звучит что при задании масива выбрали 4 строки и 4 столбца, а позиции 4,4 нет(если надо с 0 то в выводе просто поставить array[atri , colu]). 
